...
//
//
// ⚠️ 2026-08-30 反證：上面「推送只對 unknown 有效」那句話，站上自己的資料已經不支持了。
//   當日落盤：sitemap 197 筆，未收錄 114 筆＋旗艦頁保底 → 推送 119 筆、**成功 119／失敗 0**，
//   而 /equipment/compliance-check/（7/28 起）、/events/2025-hsinchu-edutech-cup/、
//   /events/2026-hsinchu-edutech-cup/、/organizations/fida-hong-kong/、
...
//   而不是照一段沒人回頭驗證過的敘述繼續每天推 119 筆。
//
// ⚠️ 2026-08-30 另一個發現：「卡住清單與上次告警相同 → 不重複發 Slack」（見下方告警邏輯）
//   本意是降噪，實際效果是**問題愈持久就愈安靜**。那 23 筆已經卡了 13–41 天，
//   清單沒變過，於是 Slack 從某一天起就不再提起它們——這正是本檔開頭想根治的那種
//   「悄悄從每天檢查變成有時候檢查」。要不要改成定期重提，待決定。
